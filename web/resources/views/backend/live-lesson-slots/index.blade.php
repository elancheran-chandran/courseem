...
@section('content')
    @if((config('zoom.api_key') == null) && (config('zoom.api_secret') == null))
        <div class="alert alert-warning" role="alert">
            If you want to create live lesson slot, you need to add zoom credentials using <a target="_blank" href="{{ route('admin.zoom-settings') }}">Zoom Settings</a>.
        </div>
    @endif
    <div class="card">
